...
static const char qt_meta_stringdata_LabToolGeneratorDevice[] = {
    "LabToolGeneratorDevice\0\0handleStopped()\0"
    "handleConfigurationDone()\0msg\0"
    "handleConfigurationFailure(const char*)\0"
    "handleRunning()\0handleRunningFailure(const char*)\0"
};
...
const QMetaObjectExtraData LabToolGeneratorDevice::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LabToolGeneratorDevice::staticMetaObject = {
    { &GeneratorDevice::staticMetaObject, qt_meta_stringdata_LabToolGeneratorDevice,
      qt_meta_data_LabToolGeneratorDevice, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LabToolGeneratorDevice::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LabToolGeneratorDevice))
