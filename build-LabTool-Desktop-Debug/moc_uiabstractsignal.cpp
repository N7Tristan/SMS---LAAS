...
struct qt_meta_stringdata_UiAbstractSignal_t {
    QByteArrayData data[6];
    char stringdata[57];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_UiAbstractSignal_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UiAbstractSignal_t qt_meta_stringdata_UiAbstractSignal = {
    {
QT_MOC_LITERAL(0, 0, 16), // "UiAbstractSignal"
QT_MOC_LITERAL(1, 17, 6), // "closed"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 17), // "UiAbstractSignal*"
QT_MOC_LITERAL(4, 43, 1), // "s"
QT_MOC_LITERAL(5, 45, 11) // "closeSignal"

    },
    "UiAbstractSignal\0closed\0\0UiAbstractSignal*\0"
    "s\0closeSignal"
};
...
void UiAbstractSignal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (UiAbstractSignal::*_t)(UiAbstractSignal * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UiAbstractSignal::closed)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject UiAbstractSignal::staticMetaObject = {
    { &UiAbstractPlotItem::staticMetaObject, qt_meta_stringdata_UiAbstractSignal.data,
      qt_meta_data_UiAbstractSignal,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UiAbstractSignal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UiAbstractSignal.stringdata))
