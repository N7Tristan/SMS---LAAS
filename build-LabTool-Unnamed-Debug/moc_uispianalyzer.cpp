...
static const char qt_meta_stringdata_UiSpiAnalyzer[] = {
    "UiSpiAnalyzer\0"
};
...
const QMetaObjectExtraData UiSpiAnalyzer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UiSpiAnalyzer::staticMetaObject = {
    { &UiAnalyzer::staticMetaObject, qt_meta_stringdata_UiSpiAnalyzer,
      qt_meta_data_UiSpiAnalyzer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UiSpiAnalyzer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UiSpiAnalyzer))
