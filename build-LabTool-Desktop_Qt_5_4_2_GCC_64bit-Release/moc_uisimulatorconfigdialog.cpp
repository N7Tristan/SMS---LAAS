...
struct qt_meta_stringdata_UiSimulatorConfigDialog_t {
    QByteArrayData data[4];
    char stringdata[57];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_UiSimulatorConfigDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UiSimulatorConfigDialog_t qt_meta_stringdata_UiSimulatorConfigDialog = {
    {
QT_MOC_LITERAL(0, 0, 23), // "UiSimulatorConfigDialog"
QT_MOC_LITERAL(1, 24, 27), // "handleDigitalFunctionChange"
QT_MOC_LITERAL(2, 52, 0), // ""
QT_MOC_LITERAL(3, 53, 3) // "idx"

    },
    "UiSimulatorConfigDialog\0"
    "handleDigitalFunctionChange\0\0idx"
};
...
const QMetaObject UiSimulatorConfigDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_UiSimulatorConfigDialog.data,
      qt_meta_data_UiSimulatorConfigDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UiSimulatorConfigDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UiSimulatorConfigDialog.stringdata))
