...
static const char qt_meta_stringdata_UiDigitalGroup[] = {
    "UiDigitalGroup\0\0start,mid,end,highLow,active\0"
    "setCycleData(double,double,double,bool,bool)\0"
};
...
const QMetaObjectExtraData UiDigitalGroup::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UiDigitalGroup::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_UiDigitalGroup,
      qt_meta_data_UiDigitalGroup, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UiDigitalGroup::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UiDigitalGroup))
