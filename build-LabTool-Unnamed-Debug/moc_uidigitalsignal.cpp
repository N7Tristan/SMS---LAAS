...
static const char qt_meta_stringdata_UiDigitalSignal[] = {
    "UiDigitalSignal\0\0start,mid,end,highLow,mActive\0"
    "cycleMeasurmentChanged(double,double,double,bool,bool)\0"
    "triggerSet()\0handleTriggerChanged()\0"
};
...
const QMetaObjectExtraData UiDigitalSignal::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UiDigitalSignal::staticMetaObject = {
    { &UiSimpleAbstractSignal::staticMetaObject, qt_meta_stringdata_UiDigitalSignal,
      qt_meta_data_UiDigitalSignal, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UiDigitalSignal::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UiDigitalSignal))
