...
struct qt_meta_stringdata_SpiGenerator_t {
    QByteArrayData data[1];
    char stringdata[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SpiGenerator_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SpiGenerator_t qt_meta_stringdata_SpiGenerator = {
    {
QT_MOC_LITERAL(0, 0, 12) // "SpiGenerator"
...
const QMetaObject SpiGenerator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SpiGenerator.data,
      qt_meta_data_SpiGenerator,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SpiGenerator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SpiGenerator.stringdata))
