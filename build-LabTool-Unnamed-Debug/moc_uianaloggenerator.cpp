...
static const char qt_meta_stringdata_UiAnalogGenerator[] = {
    "UiAnalogGenerator\0\0addSignal()\0"
};
...
const QMetaObjectExtraData UiAnalogGenerator::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UiAnalogGenerator::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UiAnalogGenerator,
      qt_meta_data_UiAnalogGenerator, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UiAnalogGenerator::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UiAnalogGenerator))
