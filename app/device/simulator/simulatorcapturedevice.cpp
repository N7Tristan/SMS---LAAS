...
int SimulatorCaptureDevice::maxNumSelfmixedSignals()
{
...
QVector<double>* SimulatorCaptureDevice::selfmixedData(int signalId)
{
    QVector<double>* data = NULL;
...
void SimulatorCaptureDevice::setSelfmixedData(int signalId, QVector<double> data)
{
    if (signalId < MaxSelfmixedSignals) {
