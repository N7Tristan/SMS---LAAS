...
static const char qt_meta_stringdata_LabToolCalibrationWizardAnalogIn[] = {
    "LabToolCalibrationWizardAnalogIn\0\0"
    "recalibrateClicked()\0msg\0"
...
const QMetaObjectExtraData LabToolCalibrationWizardAnalogIn::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LabToolCalibrationWizardAnalogIn::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_LabToolCalibrationWizardAnalogIn,
      qt_meta_data_LabToolCalibrationWizardAnalogIn, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LabToolCalibrationWizardAnalogIn::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LabToolCalibrationWizardAnalogIn))
