...
public:
    ...
    virtual int maxNumSelfmixedSignals() = 0;
    ...
    virtual QVector<double>* analogData(int signalId) = 0; //here are stocked values
...
protected:
    ...
    QList<SelfmixedSignal*> mSelfmixedSignalList;
