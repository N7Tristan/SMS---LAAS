...
struct qt_meta_stringdata_DigitalSignals_t {
    QByteArrayData data[1];
    char stringdata[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DigitalSignals_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DigitalSignals_t qt_meta_stringdata_DigitalSignals = {
    {
QT_MOC_LITERAL(0, 0, 14) // "DigitalSignals"
...
const QMetaObject DigitalSignals::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_DigitalSignals.data,
      qt_meta_data_DigitalSignals,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DigitalSignals::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DigitalSignals.stringdata))
