...
static const char qt_meta_stringdata_UiUartAnalyzerConfig[] = {
    "UiUartAnalyzerConfig\0"
};
...
const QMetaObjectExtraData UiUartAnalyzerConfig::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UiUartAnalyzerConfig::staticMetaObject = {
    { &UiAnalyzerConfig::staticMetaObject, qt_meta_stringdata_UiUartAnalyzerConfig,
      qt_meta_data_UiUartAnalyzerConfig, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UiUartAnalyzerConfig::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UiUartAnalyzerConfig))
