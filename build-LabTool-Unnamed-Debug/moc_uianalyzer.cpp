...
static const char qt_meta_stringdata_UiAnalyzer[] = {
    "UiAnalyzer\0\0parent\0configure(QWidget*)\0"
};
...
const QMetaObjectExtraData UiAnalyzer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UiAnalyzer::staticMetaObject = {
    { &UiSimpleAbstractSignal::staticMetaObject, qt_meta_stringdata_UiAnalyzer,
      qt_meta_data_UiAnalyzer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UiAnalyzer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UiAnalyzer))
