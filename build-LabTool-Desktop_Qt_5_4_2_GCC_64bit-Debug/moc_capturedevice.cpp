...
struct qt_meta_stringdata_CaptureDevice_t {
    QByteArrayData data[5];
    char stringdata[46];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CaptureDevice_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CaptureDevice_t qt_meta_stringdata_CaptureDevice = {
    {
QT_MOC_LITERAL(0, 0, 13), // "CaptureDevice"
QT_MOC_LITERAL(1, 14, 15), // "captureFinished"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 10), // "successful"
QT_MOC_LITERAL(4, 42, 3) // "msg"

    },
    "CaptureDevice\0captureFinished\0\0"
    "successful\0msg"
};
...
void CaptureDevice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CaptureDevice::*_t)(bool , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CaptureDevice::captureFinished)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CaptureDevice::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CaptureDevice.data,
      qt_meta_data_CaptureDevice,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CaptureDevice::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CaptureDevice.stringdata))
