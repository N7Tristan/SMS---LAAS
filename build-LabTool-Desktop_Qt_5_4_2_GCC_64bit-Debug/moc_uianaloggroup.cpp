...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UiAnalogGroup_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UiAnalogGroup_t qt_meta_stringdata_UiAnalogGroup = {
    {
QT_MOC_LITERAL(0, 0, 13), // "UiAnalogGroup"
QT_MOC_LITERAL(1, 14, 18), // "setMeasurementData"
...
QT_MOC_LITERAL(6, 57, 6) // "active"
    ...
    "QList<double>\0level\0pk\0active"
};
...
const QMetaObject UiAnalogGroup::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_UiAnalogGroup.data,
      qt_meta_data_UiAnalogGroup,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
