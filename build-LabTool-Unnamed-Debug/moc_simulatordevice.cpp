...
static const char qt_meta_stringdata_SimulatorDevice[] = {
    "SimulatorDevice\0"
};
...
const QMetaObjectExtraData SimulatorDevice::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SimulatorDevice::staticMetaObject = {
    { &Device::staticMetaObject, qt_meta_stringdata_SimulatorDevice,
      qt_meta_data_SimulatorDevice, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SimulatorDevice::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SimulatorDevice))
