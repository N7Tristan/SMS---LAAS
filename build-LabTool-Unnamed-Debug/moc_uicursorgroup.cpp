...
static const char qt_meta_stringdata_UiCursorGroup[] = {
    "UiCursorGroup\0\0cursor,enabled,time\0"
    "setCursorData(UiCursor::CursorId,bool,double)\0"
};
...
const QMetaObjectExtraData UiCursorGroup::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UiCursorGroup::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_UiCursorGroup,
      qt_meta_data_UiCursorGroup, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UiCursorGroup::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UiCursorGroup))
