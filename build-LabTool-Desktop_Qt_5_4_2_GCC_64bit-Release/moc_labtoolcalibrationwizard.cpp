...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LabToolCalibrationWizard_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LabToolCalibrationWizard_t qt_meta_stringdata_LabToolCalibrationWizard = {
    {
QT_MOC_LITERAL(0, 0, 24), // "LabToolCalibrationWizard"
QT_MOC_LITERAL(1, 25, 21), // "handleConnectedStatus"
QT_MOC_LITERAL(2, 47, 0), // ""
QT_MOC_LITERAL(3, 48, 9), // "connected"
QT_MOC_LITERAL(4, 58, 23), // "handleCalibrationFailed"
QT_MOC_LITERAL(5, 82, 11), // "const char*"
QT_MOC_LITERAL(6, 94, 3), // "msg"
QT_MOC_LITERAL(7, 98, 24), // "handleCalibrationSuccess"
QT_MOC_LITERAL(8, 123, 23), // "LabToolCalibrationData*"
...
const QMetaObject LabToolCalibrationWizard::staticMetaObject = {
    { &QWizard::staticMetaObject, qt_meta_stringdata_LabToolCalibrationWizard.data,
      qt_meta_data_LabToolCalibrationWizard,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
