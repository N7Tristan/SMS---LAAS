...
static const char qt_meta_stringdata_LabToolDevice[] = {
    "LabToolDevice\0\0newComm\0"
    "handleNewConnection(LabToolDeviceComm*)\0"
    "connected\0handleConnectedStatus(bool)\0"
};
...
const QMetaObjectExtraData LabToolDevice::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LabToolDevice::staticMetaObject = {
    { &Device::staticMetaObject, qt_meta_stringdata_LabToolDevice,
      qt_meta_data_LabToolDevice, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LabToolDevice::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LabToolDevice))
