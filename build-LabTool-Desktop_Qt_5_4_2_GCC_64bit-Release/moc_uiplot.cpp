...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UiPlot_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UiPlot_t qt_meta_stringdata_UiPlot = {
    {
QT_MOC_LITERAL(0, 0, 6), // "UiPlot"
QT_MOC_LITERAL(1, 7, 13), // "cursorChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 18), // "UiCursor::CursorId"
QT_MOC_LITERAL(4, 41, 12), // "updateLayout"
QT_MOC_LITERAL(5, 54, 18), // "handleSignalsAdded"
QT_MOC_LITERAL(6, 73, 20) // "handleSignalsRemoved"

    },
    "UiPlot\0cursorChanged\0\0UiCursor::CursorId\0"
    "updateLayout\0handleSignalsAdded\0"
    "handleSignalsRemoved"
};
...
const QMetaObject UiPlot::staticMetaObject = {
    { &QAbstractScrollArea::staticMetaObject, qt_meta_stringdata_UiPlot.data,
      qt_meta_data_UiPlot,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
